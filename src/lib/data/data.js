...
// Shared region colors across all regional charts (derived from the Figure 1 palette).
const regionColors = {
  europe: palette[3],
  northAmericaOceania: palette[4],
  latinAmerica: "#A9A1B8",
  middleEastNorthAfrica: "#2E86B5",
  subSaharanAfrica: palette[5],
  russiaCentralAsia: "#3E5A40",
  eastAsia: "#5F7E60",
  southSoutheastAsia: palette[2],
  world: palette[7],
};
...
export const data = [
  ...
  },
  {
    ...
    xKey: "year",
    series: [
      { key: "Europe", value: "europe", color: regionColors.europe },
      { key: "North America/Oceania", value: "northAmericaOceania", color: regionColors.northAmericaOceania },
      { key: "Latin America", value: "latinAmerica", color: regionColors.latinAmerica },
      { key: "Middle East/North Africa", value: "middleEastNorthAfrica", color: regionColors.middleEastNorthAfrica },
      { key: "Sub-Saharan Africa", value: "subSaharanAfrica", color: regionColors.subSaharanAfrica },
      { key: "Russia/Central Asia", value: "russiaCentralAsia", color: regionColors.russiaCentralAsia },
      { key: "East Asia", value: "eastAsia", color: regionColors.eastAsia },
      { key: "South/South-East Asia", value: "southSoutheastAsia", color: regionColors.southSoutheastAsia },
      { key: "World", value: "world", color: regionColors.world },
    ],
    data: [
